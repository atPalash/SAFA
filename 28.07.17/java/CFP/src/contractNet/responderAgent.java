            ...
            if (msg != null) {
                ...
                if (Objects.equals(title, capability)) {
                    ...
                    try {
                        ...
                        String path_javaReply = fs + "home" + fs + "pi" + fs + "Desktop" + fs + "testingFiles" + fs + "28.07.17" + fs + "java_reply.txt";
                        ...
                        Path dir = Paths.get(fs + "home" + fs + "pi" + fs + "Desktop" + fs + "testingFiles" + fs + "28.07.17");
                        ...
                        while (true){
                            ...
                            for (WatchEvent<?> event : key.pollEvents()) {
                                ...
                                if (kind == StandardWatchEventKinds.OVERFLOW) {
                                    ...
                                    String path_r = fs + "home" + fs + "pi" + fs + "Desktop" + fs + "testingFiles" + fs + "28.07.17" + fs +  "python_reply.txt";
